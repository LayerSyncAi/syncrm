...
export default function AppLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-content-bg">
      ...
      >
        <Topbar userName={userName} userEmail={user.email || undefined} orgName={org?.name} userTimezone={user.timezone || undefined} userWhatsappNumber={user.whatsappNumber || undefined} />
